...
from llm_wrappers.petals import Petals

from my_keys import my_huggingface_key, my_api_key, my_cse_id


# Set environment variables
os.environ["HUGGINGFACE_API_KEY"] = my_huggingface_key
